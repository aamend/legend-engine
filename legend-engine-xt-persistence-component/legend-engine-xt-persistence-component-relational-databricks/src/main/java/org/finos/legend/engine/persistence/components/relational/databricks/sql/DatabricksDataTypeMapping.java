...
package org.finos.legend.engine.persistence.components.relational.databricks.sql;
...
public class DatabricksDataTypeMapping implements DataTypeMapping
{

    // Reference: https://spark.apache.org/docs/latest/sql-ref-datatypes.html

    // need to add STRUCT, maybe interval types, short,
